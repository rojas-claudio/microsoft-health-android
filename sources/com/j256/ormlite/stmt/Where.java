...
public class Where<T, ID> {
    ...
    public Where<T, ID> and(Where<T, ID> first, Where<T, ID> second, Where<T, ID>... others) {
        ...
        Clause secondClause = pop(ManyClause.AND_OPERATION);
        Clause firstClause = pop(ManyClause.AND_OPERATION);
    ...
    public Where<T, ID> or(Where<T, ID> left, Where<T, ID> right, Where<T, ID>... others) {
        ...
        Clause secondClause = pop(ManyClause.OR_OPERATION);
        Clause firstClause = pop(ManyClause.OR_OPERATION);
