...
public interface fh extends IInterface {
    ...
    public static abstract class a extends Binder implements fh {
        ...
        /* renamed from: com.google.android.gms.internal.fh$a$a  reason: collision with other inner class name */
        /* loaded from: classes.dex */
        private static class C0029a implements fh {
            private IBinder dG;
            ...
            @Override // com.google.android.gms.internal.fh
            public void a(int i, Bundle bundle, ec ecVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusCallbacks");
        ...
        public static fh an(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fh)) ? new C0029a(iBinder) : (fh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                    a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? ec.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
    ...
    void a(int i, Bundle bundle, ec ecVar) throws RemoteException;
