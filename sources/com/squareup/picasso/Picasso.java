...
public class Picasso {
    ...
    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener, RequestTransformer requestTransformer, List<RequestHandler> extraRequestHandlers, Stats stats, boolean indicatorsEnabled, boolean loggingEnabled) {
    ...
    private static class CleanupThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    Action.RequestWeakReference<?> remove = (Action.RequestWeakReference) this.referenceQueue.remove();
                    this.handler.sendMessage(this.handler.obtainMessage(3, remove.action));
    ...
    public static class Builder {
        ...
        public Picasso build() {
            ...
            return new Picasso(context, dispatcher, this.cache, this.listener, this.transformer, this.requestHandlers, stats, this.indicatorsEnabled, this.loggingEnabled);
        }
    }
