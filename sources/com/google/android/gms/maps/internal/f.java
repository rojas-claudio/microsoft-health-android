...
public interface f extends IInterface {
    ...
    public static abstract class a extends Binder implements f {
        ...
        /* loaded from: classes.dex */
        private static class C0052a implements f {
            private IBinder dG;
        ...
        public static f Q(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof f)) ? new C0052a(iBinder) : (f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    e(d.a.af(data.readStrongBinder()));
