...
public class ViewPager2 extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: com.microsoft.blackbirdkeyboard.ViewPager2.1
        @Override // java.util.Comparator
        public int compare(ItemInfo lhs, ItemInfo rhs) {
            return lhs.position - rhs.position;
        }
    };
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.microsoft.blackbirdkeyboard.ViewPager2.2
    ...
    public static class SimpleOnPageChangeListener implements OnPageChangeListener {
        @Override // com.microsoft.blackbirdkeyboard.ViewPager2.OnPageChangeListener
    ...
    public ViewPager2(Context context) {
        ...
        this.mEndScrollRunnable = new Runnable() { // from class: com.microsoft.blackbirdkeyboard.ViewPager2.3
            @Override // java.lang.Runnable
            public void run() {
                ViewPager2.this.setScrollState(0);
                ViewPager2.this.populate();
            }
        };
        this.mScrollState = 0;
        initViewPager();
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: com.microsoft.blackbirdkeyboard.ViewPager2.SavedState.1
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == 4096 && ViewPager2.this.mAdapter != null) {
                recordCompat.setItemCount(ViewPager2.this.mAdapter.getCount());
                recordCompat.setFromIndex(ViewPager2.this.mCurItem);
                recordCompat.setToIndex(ViewPager2.this.mCurItem);
            }
        }
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            switch (action) {
                case 4096:
                    if (ViewPager2.this.canScrollHorizontally(1)) {
                        ViewPager2.this.setCurrentItem(ViewPager2.this.mCurItem + 1);
                        return true;
                    }
                    return false;
                case 8192:
        ...
        private boolean canScroll() {
            return ViewPager2.this.mAdapter != null && ViewPager2.this.mAdapter.getCount() > 1;
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.widthFactor = 0.0f;
            TypedArray a = context.obtainStyledAttributes(attrs, ViewPager2.LAYOUT_ATTRS);
