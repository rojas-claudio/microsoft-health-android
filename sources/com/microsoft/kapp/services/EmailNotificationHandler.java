...
public class EmailNotificationHandler extends BaseNotificationHandlerImpl {
    ...
    public void sendNotification(KNotification message) {
        if (this.mSettingsProvider.getUUIDsOnDevice().contains(DefaultStrappUUID.STRAPP_EMAIL)) {
            this.mCargoConnection.sendNotificationToStrapp(message, DefaultStrappUUID.STRAPP_EMAIL);
        }
    }
}
