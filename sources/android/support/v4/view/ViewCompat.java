...
public class ViewCompat {
    ...
    @IntDef({DeviceConstants.ME_TILE_ZERO_ID, PlaybackStateCompat.ACTION_STOP, PlaybackStateCompat.ACTION_PAUSE})
    /* loaded from: classes.dex */
    private @interface AccessibilityLiveRegion {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({DeviceConstants.ME_TILE_ZERO_ID, PlaybackStateCompat.ACTION_STOP, PlaybackStateCompat.ACTION_PAUSE, PlaybackStateCompat.ACTION_PLAY})
    /* loaded from: classes.dex */
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({DeviceConstants.ME_TILE_ZERO_ID, PlaybackStateCompat.ACTION_STOP, PlaybackStateCompat.ACTION_PAUSE, 3})
    /* loaded from: classes.dex */
    private @interface LayoutDirectionMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({DeviceConstants.ME_TILE_ZERO_ID, PlaybackStateCompat.ACTION_STOP, PlaybackStateCompat.ACTION_STOP})
    /* loaded from: classes.dex */
    private @interface OverScroll {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({DeviceConstants.ME_TILE_ZERO_ID, PlaybackStateCompat.ACTION_STOP})
    /* loaded from: classes.dex */
