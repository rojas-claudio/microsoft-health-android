...
public class LikeBoxCountView extends FrameLayout {
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$com$facebook$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition() {
        ...
        if (iArr == null) {
            iArr = new int[LikeBoxCountViewCaretPosition.valuesCustom().length];
            try {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch ($SWITCH_TABLE$com$facebook$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition()[this.caretPosition.ordinal()]) {
            case 1:
                left = (int) (left + this.caretHeight);
                break;
            case 2:
                top = (int) (top + this.caretHeight);
                break;
            case 3:
                right = (int) (right - this.caretHeight);
                break;
            case 4:
                bottom = (int) (bottom - this.caretHeight);
                break;
        }
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setLayoutParams(likeCountLabelLayoutParams);
