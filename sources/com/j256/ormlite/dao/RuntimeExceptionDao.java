...
public class RuntimeExceptionDao<T, ID> implements CloseableIterable<T> {
    ...
    public static <T, ID> RuntimeExceptionDao<T, ID> createDao(ConnectionSource connectionSource, Class<T> clazz) throws SQLException {
        Dao<T, ID> castDao = DaoManager.createDao(connectionSource, clazz);
    ...
    public static <T, ID> RuntimeExceptionDao<T, ID> createDao(ConnectionSource connectionSource, DatabaseTableConfig<T> tableConfig) throws SQLException {
        Dao<T, ID> castDao = DaoManager.createDao(connectionSource, tableConfig);
        return new RuntimeExceptionDao<>(castDao);
    }
    ...
    public int delete(T data) {
        try {
            return this.dao.delete((Dao<T, ID>) data);
        } catch (SQLException e) {
    ...
    public int delete(Collection<T> datas) {
        try {
            return this.dao.delete((Collection) datas);
        } catch (SQLException e) {
