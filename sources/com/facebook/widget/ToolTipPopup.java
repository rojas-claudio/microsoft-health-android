...
public class ToolTipPopup {
    ...
    private final ViewTreeObserver.OnScrollChangedListener mScrollListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: com.facebook.widget.ToolTipPopup.1
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            this.mPopupContent.onMeasure(View.MeasureSpec.makeMeasureSpec(decorWidth, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(decorHeight, Integer.MIN_VALUE));
            ...
            if (this.mNuxDisplayTime > 0) {
                this.mPopupContent.postDelayed(new Runnable() { // from class: com.facebook.widget.ToolTipPopup.2
            ...
            this.mPopupContent.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.widget.ToolTipPopup.3
