    ...
    public static class e {
        ...
        public void a() {
            ...
            if (gLSurfaceView != null) {
                this.d = gLSurfaceView.f.chooseConfig(this.a, this.b);
                this.e = gLSurfaceView.g.createContext(this.a, this.b, this.d);
            } else {
                this.d = null;
                this.e = null;
            }
        ...
        public boolean b() {
            ...
            GLSurfaceView gLSurfaceView = this.f.get();
            if (gLSurfaceView != null) {
                this.c = gLSurfaceView.h.createWindowSurface(this.a, this.b, this.d, gLSurfaceView.getHolder());
            } else {
                this.c = null;
            }
        ...
        GL c() {
            ...
            if (gLSurfaceView != null) {
                ...
                if ((gLSurfaceView.j & 3) != 0) {
                    int i = 0;
                    if ((gLSurfaceView.j & 1) != 0) {
                        i = 1;
                    }
                    if ((gLSurfaceView.j & 2) == 0) {
                        hVar = null;
                    } else {
                        hVar = new h();
                    }
        ...
        private void g() {
            if (this.c != null && this.c != EGL10.EGL_NO_SURFACE) {
                ...
                GLSurfaceView gLSurfaceView = this.f.get();
                if (gLSurfaceView != null) {
                    gLSurfaceView.h.destroySurface(this.a, this.b, this.c);
                }
                this.c = null;
            }
        }
        ...
        public void f() {
            if (this.e != null) {
                GLSurfaceView gLSurfaceView = this.f.get();
                if (gLSurfaceView != null) {
                    gLSurfaceView.g.destroyContext(this.a, this.b, this.e);
                }
                this.e = null;
            }
            if (this.b != null) {
            ...
            while (true) {
                try {
                    synchronized (GLSurfaceView.a) {
                        while (!this.a) {
                            if (!this.q.isEmpty()) {
                                ...
                                if (z9 && this.h) {
                                    GLSurfaceView gLSurfaceView = this.t.get();
                                    if (!(gLSurfaceView == null ? false : gLSurfaceView.l) || GLSurfaceView.a.a()) {
                                        k();
                                    }
                                }
                                if (z9 && GLSurfaceView.a.b()) {
                                    this.s.f();
                                }
                                if (!this.e && !this.g) {
                                    if (this.i) {
                    ...
                    if (remove != null) {
                        ...
                        if (z15) {
                            GLSurfaceView gLSurfaceView2 = this.t.get();
                            if (gLSurfaceView2 != null) {
                                gLSurfaceView2.d.onSurfaceCreated(gl10, this.s.d);
                            }
                            z15 = false;
                        }
                        if (z5) {
                            GLSurfaceView gLSurfaceView3 = this.t.get();
                            if (gLSurfaceView3 != null) {
                                gLSurfaceView3.d.onSurfaceChanged(gl10, i, i2);
                            }
                            z5 = false;
                        }
                        GLSurfaceView gLSurfaceView4 = this.t.get();
                        if (gLSurfaceView4 != null) {
                            gLSurfaceView4.d.onDrawFrame(gl10);
                        }
                        int d = this.s.d();
                        switch (d) {
