    ...
    public static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                float x = (float) ((this.mRingCenterRadius * Math.cos(Constants.SPLITS_ACCURACY)) + bounds.exactCenterX());
                float y = (float) ((this.mRingCenterRadius * Math.sin(Constants.SPLITS_ACCURACY)) + bounds.exactCenterY());
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= Constants.SPLITS_ACCURACY || minEdge < 0.0f) {
