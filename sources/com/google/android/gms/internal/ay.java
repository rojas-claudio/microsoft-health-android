...
public interface ay extends IInterface {
    ...
    public static abstract class a extends Binder implements ay {
        ...
        /* loaded from: classes.dex */
        private static class C0011a implements ay {
            private IBinder dG;
        ...
        public static ay k(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ay)) ? new C0011a(iBinder) : (ay) queryLocalInterface;
        }
