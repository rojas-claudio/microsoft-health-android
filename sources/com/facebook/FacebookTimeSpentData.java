...
class FacebookTimeSpentData implements Serializable {
    ...
    private static class SerializationProxyV1 implements Serializable {
        ...
        private Object readResolve() {
            return new FacebookTimeSpentData(this.lastResumeTime, this.lastSuspendTime, this.millisecondsSpentInSession, this.interruptionCount, (FacebookTimeSpentData) null);
        }
    }
    ...
    public void onResume(AppEventsLogger logger, long eventTime, String sourceApplicationInfo) {
        ...
        long interruptionDurationMillis = wasSuspendedEver() ? eventTime - this.lastSuspendTime : 0L;
    ...
    private void logAppDeactivatedEvent(AppEventsLogger logger, long interruptionDurationMillis) {
        ...
        eventParams.putString(AppEventsConstants.EVENT_NAME_TIME_BETWEEN_SESSIONS, String.format("session_quanta_%d", Integer.valueOf(getQuantaIndex(interruptionDurationMillis))));
