...
public interface bn extends IInterface {
    ...
    public static abstract class a extends Binder implements bn {
        ...
        /* loaded from: classes.dex */
        private static class C0013a implements bn {
            private IBinder dG;
        ...
        public static bn m(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.overlay.client.IAdOverlay");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bn)) ? new C0013a(iBinder) : (bn) queryLocalInterface;
        }
