...
public class DefaultItemAnimator extends RecyclerView.ItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            while (i$.hasNext()) {
                RecyclerView.ViewHolder holder = i$.next();
            ...
            if (movesPending) {
                ...
                Runnable mover = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.1
                    ...
                    public void run() {
                        Iterator i$2 = moves.iterator();
                        while (i$2.hasNext()) {
                            MoveInfo moveInfo = (MoveInfo) i$2.next();
            ...
            if (changesPending) {
                ...
                Runnable changer = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.2
                    @Override // java.lang.Runnable
                    public void run() {
                        Iterator i$2 = changes.iterator();
                        while (i$2.hasNext()) {
                            ChangeInfo change = (ChangeInfo) i$2.next();
            ...
            if (additionsPending) {
                ...
                Runnable adder = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.3
                    @Override // java.lang.Runnable
                    public void run() {
                        Iterator i$2 = additions.iterator();
                        while (i$2.hasNext()) {
                            RecyclerView.ViewHolder holder3 = (RecyclerView.ViewHolder) i$2.next();
