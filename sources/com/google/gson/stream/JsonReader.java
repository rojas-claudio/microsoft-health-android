...
public class JsonReader implements Closeable {
            ...
            public void promoteNameToValue(JsonReader reader) throws IOException {
                if (!(reader instanceof JsonTreeReader)) {
                    ...
                    if (p == 13) {
                        ...
                        throw new IllegalStateException("Expected a name but was " + reader.peek() + MetricSpannerUtils.METRIC_UNITS_SEPARATOR_SPACE + " at line " + reader.getLineNumber() + " column " + reader.getColumnNumber() + " path " + reader.getPath());
                    }
                }
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c == 't' || c == 'T') {
            keyword = ServerProtocol.DIALOG_RETURN_SCOPES_TRUE;
            keywordUpper = "TRUE";
            peeking = 5;
        } else if (c == 'f' || c == 'F') {
            keyword = "false";
