...
public interface d extends IInterface {
    ...
    public static abstract class a extends Binder implements d {
        ...
        public static class C0067a implements d {
            ...
            @Override // com.google.android.gms.maps.model.internal.d
            public void i(com.google.android.gms.dynamic.b bVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 10:
                    ...
                    reply.writeNoException();
                    reply.writeInt(isDraggable ? 1 : 0);
                    return true;
                case 11:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    showInfoWindow();
                ...
                case 13:
                    ...
                    reply.writeNoException();
                    reply.writeInt(isInfoWindowShown ? 1 : 0);
                    return true;
                case 14:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                ...
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    boolean h = h(af(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(h ? 1 : 0);
                    return true;
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
