...
public class FeedbackParser {
    ...
    public FeedbackResponse parseFeedbackResponse(String feedbackResponseJson) {
            ...
            try {
                ...
                if (messagesArray.length() > 0) {
                    ...
                    for (int i = 0; i < messagesArray.length(); i++) {
                        ...
                        String text = messagesArray.getJSONObject(i).getString(MmsColumns.MMS_PART_TEXT).toString();
                        ...
                        String token = messagesArray.getJSONObject(i).getString(ServerProtocol.DIALOG_RESPONSE_TYPE_TOKEN).toString();
                        ...
                        String name = messagesArray.getJSONObject(i).getString(WorkoutSummary.NAME).toString();
                ...
                try {
                    feedback.setName(feedbackObject.getString(WorkoutSummary.NAME).toString());
        ...
        try {
            ...
            try {
                feedbackResponse.setToken(jsonObject.getString(ServerProtocol.DIALOG_RESPONSE_TYPE_TOKEN).toString());
