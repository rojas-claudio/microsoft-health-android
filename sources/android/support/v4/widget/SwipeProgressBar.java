...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            long elapsed = (now - this.mStartTime) % CargoCloudClient.CLOUD_PROCESSING_SUCCESS_WAIT_TIME;
            long iterations = (now - this.mStartTime) / CargoCloudClient.CLOUD_PROCESSING_SUCCESS_WAIT_TIME;
