...
public final class Utils {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0032, code lost:
        if (java.lang.Integer.parseInt(r1[1]) == 304) goto L17;
     */
    /*
    ...
    */
    ...
    public static boolean isWebPFile(InputStream stream) throws IOException {
        ...
        if (stream.read(fileHeaderBytes, 0, 12) == 12) {
            return WEBP_FILE_HEADER_RIFF.equals(new String(fileHeaderBytes, 0, 4, CharEncoding.US_ASCII)) && WEBP_FILE_HEADER_WEBP.equals(new String(fileHeaderBytes, 8, 4, CharEncoding.US_ASCII));
        }
        return false;
    }
