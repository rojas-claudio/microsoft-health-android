...
public class DatabaseFieldConfig {
    ...
    public static Method findSetMethod(Field field, boolean throwExceptions) {
        ...
        try {
            Method fieldSetMethod = field.getDeclaringClass().getMethod(methodName, field.getType());
    ...
    private String findIndexName(String tableName) {
        return this.columnName == null ? tableName + "_" + this.fieldName + "_idx" : tableName + "_" + this.columnName + "_idx";
    }
